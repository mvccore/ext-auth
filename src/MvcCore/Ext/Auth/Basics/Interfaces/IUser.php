...
interface IUser
{
	...
	// trait: \MvcCore\Ext\Auth\Basics\Traits\UserAndRole\Base
	 ...
	 * Example: `0 | 1 | 2...`
	 * @param int|NULL $id
	 * @return \MvcCore\Ext\Auth\Basics\Interfaces\IUser
	 */
	...
	// trait: \MvcCore\Ext\Auth\Basics\Traits\User\Base
	...
	// trait: \MvcCore\Ext\Auth\Basics\Traits\User\Auth
	 ...
	 * @param string $password Submitted and cleaned password. Characters `' " ` < > \ = ^ | & ~` are automaticly encoded to html entities by default `\MvcCore\Ext\Auth\Basic` sign in form.
	 * @return \MvcCore\Ext\Auth\Basics\Interfaces\IUser|NULL
	 */
	 ...
	 * by `\MvcCore\Ext\Auth\Basic` extension configuration or
	...
	// trait: \MvcCore\Ext\Auth\Basics\Traits\User\Roles
	 ...
	 * @param \string[]|\MvcCore\Ext\Auth\Basics\Interfaces\IRole[] $rolesOrRolesNames
	 * @return \MvcCore\Ext\Auth\Basics\Interfaces\IUser
	 */
	 ...
	 * @param string|\MvcCore\Ext\Auth\Basics\Interfaces\IRole $roleOrRoleName
	...
	// trait: \MvcCore\Ext\Auth\Basics\Traits\UserAndRole\Permissions
	...
	// class: \MvcCore\Ext\Auth\Basics\User
