...
trait Roles
{
	 ...
	 * @param \string[]|\MvcCore\Ext\Auth\Basics\Role[]|\MvcCore\Ext\Auth\Basics\Interfaces\IRole[] $rolesOrRolesNames
	 * @return \MvcCore\Ext\Auth\Basics\User|\MvcCore\Ext\Auth\Basics\Interfaces\IUser
	 */
	 ...
	 * @param string|\MvcCore\Ext\Auth\Basics\Role|\MvcCore\Ext\Auth\Basics\Interfaces\IRole $roleOrRoleName
	...
	public function IsAllowed ($permissionName) {
		...
		$roleClass = \MvcCore\Ext\Auth\Basic::GetInstance()->GetRoleClass();
	...
	protected static function getRoleName ($roleOrRoleName) {
		...
		} else if ($roleOrRoleName instanceof \MvcCore\Ext\Auth\Basics\Interfaces\IRole) {
			return $roleOrRoleName->GetName();
		} else {
			throw new \InvalidArgumentException(
				'['.__CLASS__."] Given argument `$roleOrRoleName` doesn't "
				."implement interface `\MvcCore\Ext\Auth\Basics\Interfaces\IRole` "
