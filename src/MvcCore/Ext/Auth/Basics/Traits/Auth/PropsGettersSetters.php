...
trait PropsGettersSetters
{
	 ...
	 * @var \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth|NULL
	 */
	 ...
	 * `\MvcCore\Ext\Auth\Basics\Interfaces\IUser`.
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\User`.
	 * @var string
	 */
	 ...
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\Controller`.
	 * @var string
	 */
	 ...
	 * Class name has to implement interface
	 * `\MvcCore\Ext\Auth\Basics\Interfaces\IForm`.
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\SignInForm`.
	 * @var string
	 */
	 ...
	 * `\MvcCore\Ext\Auth\Basics\Interfaces\IForm`.
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\SignOutForm`.
	 * @var string
	 */
	 ...
	 * @var \MvcCore\Ext\Auth\Basics\User|\MvcCore\Ext\Auth\Basics\Interfaces\IUser|NULL
	 */
	protected $user = NULL;
	 ...
	 * @var \MvcCore\Ext\Auth\Basics\Traits\Form|\MvcCore\Ext\Auth\Basics\Interfaces\IForm|\MvcCore\Ext\Auth\Basics\SignInForm|\MvcCore\Ext\Auth\Basics\SignOutForm
	 */
	protected $form = NULL;

	/**
	 * This is only internal semaphore to call
	 * `\MvcCore\Ext\Auth\Basics\User::SetUpUserBySession()`
	 ...
	 * @return \MvcCore\Ext\Auth\Basics\User|\MvcCore\Ext\Auth\Basics\Interfaces\IUser|NULL
	 */
	 ...
	 * @return \MvcCore\Ext\Auth\Basics\SignInForm|\MvcCore\Ext\Auth\Basics\Interfaces\IForm
	 */
	 ...
	 * Form instance completition is processed only once,
	 * created form instance is stored in `$auth->form` property.
	 * @return \MvcCore\Ext\Auth\Basics\SignOutForm|\MvcCore\Ext\Auth\Basics\Interfaces\IForm
	 */
	 ...
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\User`.
	 * @param string $userClass User full class name implementing `\MvcCore\Ext\Auth\Basics\Interfaces\IUser`.
	 * @return \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth
	 */
	 ...
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\Controller`.
	 * @param string $controllerClass Controller full class name implementing `\MvcCore\Ext\Auth\Basics\Interfaces\IController`.
	 * @return \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth
	 */
	public function & SetControllerClass ($controllerClass = '') {
		$controllerClass = $this->checkClassImplementation(
			$controllerClass, \MvcCore\Ext\Auth\Basics\Interfaces\IController::class, FALSE
		);
	 ...
	 * Default value after auth module init is
	 * configured to `\MvcCore\Ext\Auth\Basics\SignInForm`.
	 * @param string $signInFormClass Form full class name implementing `\MvcCore\Ext\Auth\Basics\Interfaces\IForm`.
	 * @return \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth
	 */
	public function & SetSignInFormClass ($signInFormClass = '') {
		$this->signInFormClass = $this->checkClassImplementation(
			$signInFormClass, \MvcCore\Ext\Auth\Basics\Interfaces\IForm::class, FALSE
		);
		return $this;
	}
	...
	public function & SetSignOutFormClass ($signOutFormClass = '') {
		$this->signOutFormClass = $this->checkClassImplementation(
			$signOutFormClass, \MvcCore\Ext\Auth\Basics\Interfaces\IForm::class, FALSE
		);
		return $this;
	}
	 ...
	 * @param \MvcCore\Ext\Auth\Basics\User|\MvcCore\Ext\Auth\Basics\Interfaces\IUser|NULL $user
	 * @return \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth
	 */
	public function & SetUser (\MvcCore\Ext\Auth\Basics\Interfaces\IUser & $user = NULL) {
		$this->user = $user;
		if ($this->user !== NULL) $this->user->SetPasswordHash(NULL);
		$this->userInitialized = TRUE;
		return $this;
	 ...
	 * @param \MvcCore\Ext\Auth\Basics\SignInForm|\MvcCore\Ext\Auth\Basics\SignOutForm|\MvcCore\Ext\Auth\Basics\Traits\Form|\MvcCore\Ext\Auth\Basics\Interfaces\IForm $form
	 * @return \MvcCore\Ext\Auth\Basic|\MvcCore\Ext\Auth\Basics\Interfaces\IAuth
	 */
	public function & SetForm (\MvcCore\Ext\Auth\Basics\Interfaces\IForm & $form) {
		$this->form = $form;
		return $this;
	}
	 ...
	 * to database user: `\MvcCore\Ext\Auth\Basics\Users\Database`.
	 * Alias for `\MvcCore\Ext\Auth\Basics\Users\Database::SetUsersTableStructure($tableName, $columnNames);`.
	...
	public function & SetTableStructureForDbUsers ($tableName = NULL, $columnNames = NULL) {
		...
		if ($toolClass::CheckClassInterface($userClass, \MvcCore\Ext\Auth\Basics\Interfaces\IDatabaseUser::class, TRUE, TRUE)) {
